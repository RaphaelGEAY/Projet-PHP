...
<div class="card">
    ...
    <?php if ($target['profile_photo']): ?>
        <img class="car-image" style="max-width:220px;height:220px;" src="<?= e($target['profile_photo']) ?>" alt="Photo de profil">
    <?php endif; ?>
...
<?php if ($isSelf): ?>
    <div class="form-card">
        ...
        <form method="post">
            ...
            <input id="profile_photo" type="url" name="profile_photo" value="<?= e((string) ($self['profile_photo'] ?? '')) ?>">
